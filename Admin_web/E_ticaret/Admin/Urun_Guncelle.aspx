<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminAnaSayfa.Master" AutoEventWireup="true" CodeBehind="Urun_Guncelle.aspx.cs" Inherits="E_ticaret.Admin.Urun_Guncelle" async="true"%>
        ...
        <ContentTemplate>
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <br />
                    <br />
                    <asp:Button ID="btnUrunekle" runat="server" Text="Ürünü güncelle" CssClass="btn btn-primary" OnClick="btnUrunGuncelle_Click" />
                </div>
