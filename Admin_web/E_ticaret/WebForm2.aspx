<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm2.aspx.cs" Inherits="E_ticaret.WebForm2" %>
                                    ...
                                    <ItemTemplate>
                                        <div class="item">
                                            <div class="thumb">
                                                ...
                                                <img src="<%# Eval("Urun_Resmi") %>" alt="">
                                            </div>
                                            <div class="down-content">
                                                <h4><%# Eval("Urun_Adi") %></h4>
                                                <span>₺<%# string.Format("{0:F2}", Eval("Urun_Fiyat")) %></span>
                                                <ul class="stars">
